...
public class ClubOKResetPanel extends JPanel {
	 ...
	 */
	public ClubOKResetPanel(ClubAddDataListener clubListener) {

		clubAddDataListener = clubListener;
		...
		btn_OK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				clubAddDataListener.clubAddDataEntered();
			}
		});
		...
		btn_Reset.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent ae) {
				clubAddResetListener.clubAddResetEntered();
			}
		});
