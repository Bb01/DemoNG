 ...
 * 
 */
public class PersonAddDataEntryPanel extends JPanel {
	...
	private static final Logger personDataEntryPanelLog = LogManager.getLogger(PersonAddDataEntryPanel.class.getName());

	/**
	 * Create the Person Data Entry Panel
	 * 
	 * This panel is used to contain a series of labels and text fields that are
	 * used to enter basic data about the person.
	 *
	 * The data is collected but NOT validated. Mouse over tool tips/hints are
	 * in place for each JLabel field.
	 */
	public PersonAddDataEntryPanel() {

		personDataEntryPanelLog.trace("PersonDataEntryPanel() Entering.");

		/*
		 * Surround the JPanel with a border of 5 pixels.
		 */
		// setBorder(new EmptyBorder(5, 5, 5, 5));
		setBorder(BorderFactory.createTitledBorder("PersonDataEntryPanel"));
